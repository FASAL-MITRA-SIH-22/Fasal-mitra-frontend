            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
              ...
              <div>
                ...
                <div class="mt-1 flex justify-center" >
                  {!isPreview && <img src={default_crop} class="p-1 bg-white border rounded max-w-sm opacity-50" required></img>}
              ...
              <div >
                ...
                <div ref={drop  } class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
